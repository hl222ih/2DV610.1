...
namespace _2DV610.Test
{
    public class APathCommandTest
    {
        ...
        [Fact]
        public void ConstructorShouldSetCorrectValues15()
        {
            //Quarter circle, horizontal, right to left, clockwise
            float radius = (float)(Math.Sqrt(2) * 32);
            string path = "a" + radius + "," + radius + " 0 0,1 -32,0";
            PathCommand sut = new PathCommand(path, 10, 20);
        ...
        [Fact]
        public void ConstructorShouldSetCorrectValues16()
        {
            //Quarter circle, horizontal, right to left, counter-clockwise
            float radius = (float)(Math.Sqrt(2) * 32);
            string path = "a" + radius + "," + radius + " 0 0,0 -32,0";
            PathCommand sut = new PathCommand(path, 10, 20);
        ...
        [Fact]
        public void ConstructorShouldSetCorrectValues17()
        {
            //Quarter circle, vertical, upper to lower, clockwise
            float radius = (float)(Math.Sqrt(2) * 32);
        ...
        [Fact]
        public void ConstructorShouldSetCorrectValues18()
        {
            //Quarter circle, vertical, upper to lower, counter-clockwise
            float radius = (float)(Math.Sqrt(2) * 32);
        ...
        [Fact]
        public void ConstructorShouldSetCorrectValues19()
        {
